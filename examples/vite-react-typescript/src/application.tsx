import { useUnit } from "orbite/react";
    ...
    <div className="App">
      <div>
        <a href="https://effector.dev" target="_blank">
          <img src={effectorLogo} className="logo effector" alt="Effector logo" />
        </a>
      ...
      <h1>Effector + Vite + React = Orbite</h1>
      <div className="card">
      ...
      <p className="read-the-docs">Click on the Effector, Vite, and React logos to learn more</p>
    </div>
  );
}
